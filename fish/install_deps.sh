...
install_fish() {
    ...
    curl -sfL "https://github.com/fish-shell/fish-shell/releases/download/$FISH_LATEST/fish-${FISH_LATEST}-linux-x86_64.tar.xz" | tar xJ
    sudo mv fish /usr/bin/fish
    echo 'Installed fish to /usr/bin/fish'
    echo 'Run:'
    echo ''
